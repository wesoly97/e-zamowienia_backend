...
export const invalidLoginOrPassword = (res: Response) => res.status(401).json({ message: getTranslation({ key: 'errors.invalidEmailOrPassword' }) })
export const invalidPassword = (res: Response) => res.status(401).json({ message: getTranslation({ key: 'errors.invalidPassword' }) })
...
export const invalidToken = (res: Response) => res.status(401).json({ message: getTranslation({ key: 'errors.invalidToken' }) })
